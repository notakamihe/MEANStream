...
import { getFilename, getServerFileUrl, toMonthShortNatural } from 'src/app/utils/utils';
...
export class EditCollectionComponent implements OnInit {
    ...
    updateCollection () {
        ...
        this.collectionService.updateCollection(this.collection._id, this.category, this.description, this.visibility == "private", releaseDate, this.title).subscribe(async (collection : Collection) => {
            ...
            this.router.navigateByUrl(`/tabs/users/${collection.user.username}/collections/${collection.slug}`) 
        }, (error : ErrorEvent) => {
